...
for (k in 1:2)
{
  ...
  {
    if (true$Sex[i] == "Male")
    {if (predictions$Classifier.1[i] == 1 && predictions$X[i] >= 0.50)
    {counter_m = counter_m + 1}
      else if (predictions$X[i] < 0.50)
      {m_unc = m_unc +1
      print(i)}
    }
  }
  ...
  for (i in 1:nrow(true))
  {
    ...
    {if (predictions$Classifier.1[i] == 2 && predictions$X[i] >= 0.50)
  ...
  {
    if (true$Sex[i] == "Male")
    {if (predictions$Classifier.2[i] == 1 && predictions$X.1[i] >= 0.50)
    {counter_m = counter_m + 1}
      else if (predictions$X.1[i] < 0.50)
      {m_unc = m_unc +1}
    }
  }
  ...
  {
    if (true$Sex[i] == "Female")
    {if (predictions$Classifier.2[i] == 2 && predictions$X.1[i] >= 0.50)
    {counter_f = counter_f + 1}
      else if (predictions$X.1[i] < 0.50)
      {f_unc = f_unc +1}
    }
  ...
  {
    if (true$Sex[i] == "Male")
    {if (predictions$Classifier.3[i] == 1 && predictions$X.2[i] >= 0.50)
    {counter_m = counter_m + 1}
      else if (predictions$X.2[i] < 0.50)
      {m_unc = m_unc +1}
    }
  }
  ...
  {
    if (true$Sex[i] == "Female")
    {if (predictions$Classifier.3[i] == 2 && predictions$X.2[i] >= 0.50)
    {counter_f = counter_f + 1}
      else if (predictions$X.2[i] < 0.50)
      {f_unc = f_unc +1}
    }
